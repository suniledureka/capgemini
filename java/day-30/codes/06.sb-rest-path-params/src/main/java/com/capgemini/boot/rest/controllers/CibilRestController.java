...
public class CibilRestController {
	...
	//@GetMapping("/score/{cname}/{pan}")
	@GetMapping("/{cname}/score/{pan}")
	public ResponseEntity<String> findCibilScore(@PathVariable("cname") String cname,
												 @PathVariable(name = "pan") String pan){
